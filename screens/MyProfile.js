    ...
    return(
        ...
        <View style={styles.bigbox}>
            ...
            <View style={{marginTop: 10}}>
                ...
                <Post profilepic= {user.image} firstName={user.firstname} lastName={user.lastname} path="false" caption="Look at this important information" image={dummydata2.image} timeposted="1 hour ago" username={user.username}/>
            </View>
            </ScrollView>
