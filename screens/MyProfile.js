...
export default function MyProfile() {
    ...
    return(
        ...
        <View style={styles.bigbox}>
            ...
            <View style={styles.friendsinfo}>
                <TouchableOpacity style={styles.editprofileuni}>
                    <Text style={styles.editprofileunitext}>Edit uni or bio</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.editprofilepic} onPress={toggleModal}>
                <EditProfilePic isVisible={isModalVisible} toggleModal={toggleModal} />
